                ...
                <div className="flex flex-col items-center text-center space-y-12">
                    ...
                    >
                        <motion.div variants={itemVariants} className="mb-6">
                            <span className="text-primary font-bold text-xl sm:text-2xl italic">Hi, I&apos;m</span>
                        </motion.div>

                        <motion.h1
                            variants={itemVariants}
                            className="text-5xl sm:text-7xl lg:text-9xl font-black tracking-tighter leading-[0.8] mb-12 flex flex-col sm:flex-row gap-x-6 justify-center items-center"
                        >
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center w-full max-w-6xl">
                            {/* Photo (Now more central in the flow) */}
                            <motion.div
                                variants={imageVariants}
                                initial="hidden"
                                animate="visible"
                                className="relative justify-self-center w-full max-w-[380px] order-1 lg:order-2"
                            >
                                <div className="relative z-10 rounded-[4rem] overflow-hidden border-2 border-white/10 shadow-3xl group aspect-[4/5] w-full bg-black/40 backdrop-blur-sm">
                                    <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/20 to-transparent opacity-60 z-20" />
                                    <Image
                                        src="/profile_new.jpg"
                                        alt="Gabriel Panashe"
                                        fill
                                        ...
                                        priority
                                    />
                                    <div className="absolute bottom-10 left-0 right-0 z-30 opacity-0 group-hover:opacity-100 transition-all duration-700 transform translate-y-4 group-hover:translate-y-0">
                                        <p className="text-white text-3xl font-black tracking-tight uppercase">G. PANASHE</p>
                                        <p className="text-primary font-bold text-sm tracking-widest uppercase mt-2">Engineering the Future</p>
                                    </div>
                                </div>
                                <div className="absolute -top-12 -right-12 w-48 h-48 bg-primary/20 rounded-full blur-3xl -z-10 animate-pulse delay-700" />
                                <div className="absolute -bottom-12 -left-12 w-48 h-48 bg-white/10 rounded-full blur-3xl -z-10 animate-pulse" />
                            </motion.div>
                            ...
                            <div className="flex flex-col items-center lg:items-start text-center lg:text-left order-2 lg:order-1 space-y-8">
                                <motion.p
                                    variants={itemVariants}
                                    className="text-xl sm:text-2xl text-muted-foreground font-medium max-w-xl leading-relaxed"
                                >
                                ...
                                <motion.div
                                    variants={itemVariants}
                                    className="flex flex-wrap items-center justify-center lg:justify-start gap-6 w-full"
                                >
                                ...
                                <motion.div variants={itemVariants} className="flex items-center gap-2 text-muted-foreground justify-center lg:justify-start">
